...
df_preds_cat = pd.read_csv('preds_cat.csv', encoding='utf-8')
...
layout = html.Div([
    dbc.Row([
        dbc.Col([
            ...
            html.P('Здесь вы увидите карту текущих аварий', style={'textAlign': 'center'}),
            dl.Map(id='map_id', style={'width': '95%', 'height': '700px'}, center=[55.7558, 37.6173], zoom=11, children=[
